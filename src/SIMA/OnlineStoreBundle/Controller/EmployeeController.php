...
use SIMA\OnlineStoreBundle\Entity\Employee;
...
class EmployeeController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $employees = $em->getRepository('SIMAOnlineStoreBundle:Employee')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('SIMA\OnlineStoreBundle\Form\EmployeeType', $employee);
    ...
    {
        $deleteForm = $this->createDeleteForm($employee);
        $editForm = $this->createForm('SIMA\OnlineStoreBundle\Form\EmployeeType', $employee);
